...
from app.schemas.users_schema import Token, TokenData, UserResponse, UserRegister, PasswordRequest
import re
...
@user_router.post("/users/register", response_model=UserResponse, name="Create a new user" )
...
@user_router.put("/user",response_model=UserResponse, name="Update a user details with a particular id")
...
@user_router.put("/users/password", name="Changes a users password with a particular id")
...
@user_router.get("/user", response_model=UserResponse, name="Get details of a particular user")
